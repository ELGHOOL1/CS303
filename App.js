  ...
  return ( 
    <View style={styles.container}> 
      ...
      <View style={styles.bu}> 
        <Button title="LOGIN" color="blue" onPress={()=>alert("Login Successfully")}></Button> 
      </View> 
      <View style={styles.bu1}> 
        <Button title="Regester" color="red" onPress={()=>alert("Regiser Successfully")}></Button> 
      </View> 
      <View style={styles.bu2}> 
        <Button title="Click ME" color="green" onPress={()=>alert("Click Successfully")}></Button> 
      </View> 
